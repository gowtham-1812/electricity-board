...
const BillCalculator = () => {
  ...
  return (
    <div className="bill-calculator-container">
      <h2 className="calculator-title">Electricity Bill Calculator</h2>
      ...
      {calculation && (
        <div className="calculation-section">
          ...
          <div className="calculation-details">
            <p><strong>Previous Reading:</strong> {calculation.previousReading}</p>
            <div className="reading-input">
              <label><strong>Current Reading:</strong></label>
              <input
                type="number"
            ...
            <p><strong>Units Consumed:</strong> {calculation.unitsConsumed}</p>
            <p><strong>Amount Due:</strong> ₹{calculation.amount.toFixed(2)}</p>
            <p><strong>Due Date:</strong> {new Date(calculation.dueDate).toLocaleDateString()}</p>
          </div>
          <button
